// ==UserScript==
// @name         MeTruyenChu_NetCreateEbook
...
//Init Xpath
var xpath_book_name = '//h1/a';
var xpath_book_author = '//div[@itemprop="author"]//a/span[@itemprop="name"]';
var xpath_book_status = '//span[@class="text-success"]';
var xpath_book_dis = '//div[contains(@class,"desc-text")]/p';
var xpath_book_cov = '//*[@id="app"]/main//div/img';
var xpath_first_chap = '//*[@id="firstChapter"]'

var xpath_chap_name = '//span[@class="chapter-text"]';
...
function add_button(element){
	...
	let element_parent = document.getElementById("nguyen_button");
	if (element_parent!=null){
		element.innerHTML = "<div id='nguyen_header'></div>";
	}else{
		let header = document.createElement("div");
		header.setAttribute("id","nguyen_button")
		element.insertBefore(header, element.firstChild);
	}
	element = document.getElementById("nguyen_button")
